parser grammar AntlrXcssParser;

options {
	tokenVocab = AntlrXcssLexer;
}
...
// Comments might be part of CSS hacks, thus pass them to visitor to decide whether to skip Spaces
// are significant around '+' '-' '(', thus they should not be skipped
ws: ( Comment | Space)*;